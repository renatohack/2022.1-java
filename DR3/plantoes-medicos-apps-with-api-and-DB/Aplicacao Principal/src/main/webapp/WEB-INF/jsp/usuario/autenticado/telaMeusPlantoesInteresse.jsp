...
<head>
    ...
    <title>Consulta de Meus Plantões de Interesse</title>
</head>

<body>
<div class="container">

    <h1>Consulta de Meus Plantões de Interesse</h1>
    ...
    <table class="table">
        ...
        <c:forEach items="${listaPlantoes}" var="plantao">
            <tr>
                ...
                <td><a href="/usuario/autenticado/desinteressarDoPlantao?idPlantao=${plantao.idPlantao}">Não me interesso mais!</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
